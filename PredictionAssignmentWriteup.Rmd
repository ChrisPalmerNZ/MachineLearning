...
- Application to sampled test data has estimated accuracy of `r (predictA_accuracy + predictB_accuracy) / 2`%
- Our final cross validated out-of-sample error rate estimate is `r 100 - ((predictA_accuracy + predictB_accuracy) / 2)`%
